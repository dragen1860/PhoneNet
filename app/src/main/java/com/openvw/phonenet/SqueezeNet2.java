...
public class SqueezeNet2 {
    ...
    public void seqSqueezeNet (Context context) throws InterruptedException {
        ...
        Log.e(tag, "Fire2_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire2_expand1x1 finished.");
        ...
        Log.e(tag, "Fire2_expand3x3 finished.");
        ...
        Log.e(tag, "Fire2_concat finished.");
        ...
        Log.e(tag, "Fire3_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire3_expand1x1 finished.");
        ...
        Log.e(tag, "Fire3_expand3x3 finished.");
        ...
        Log.e(tag, "Fire3_concat finished.");
        ...
        Log.e(tag, "Fire4_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire4_expand1x1 finished.");
        ...
        Log.e(tag, "Fire4_expand3x3 finished.");
        ...
        Log.e(tag, "Fire4_concat finished.");
        ...
        Log.e(tag, "Fire5_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire5_expand1x1 finished.");
        ...
        Log.e(tag, "Fire5_expand3x3 finished.");
        ...
        Log.e(tag, "Fire5_concat finished.");
        ...
        Log.e(tag, "Fire6_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire6_expand1x1 finished.");
        ...
        Log.e(tag, "Fire6_expand3x3 finished.");
        ...
        Log.e(tag, "Fire6_concat finished.");
        ...
        Log.e(tag, "Fire7_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire7_expand1x1 finished.");
        ...
        Log.e(tag, "Fire7_expand3x3 finished.");
        ...
        Log.e(tag, "Fire7_concat finished.");
        ...
        Log.e(tag, "Fire8_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire8_expand1x1 finished.");
        ...
        Log.e(tag, "Fire8_expand3x3 finished.");
        ...
        Log.e(tag, "Fire8_concat finished.");
        ...
        Log.e(tag, "Fire9_squeeze1x1 finished.");
        ...
        Log.e(tag, "Fire9_expand1x1 finished.");
        ...
        Log.e(tag, "Fire9_expand3x3 finished.");
        ...
        Log.e(tag, "Fire9_concat finished.");
    ...
    public void parSqueezeNet (Context context) throws InterruptedException {
         ...
         *     private void paraConvRelu (RenderScript rs, ScriptC_convNet convNet, int wghtSzF4, int biasSz,
         float[] wght, float[] bias, int exeSpaceSz,
         int K, int Wout, int Hout, int Win, int Hin, int M, int N, int S, int pad,int N_new, int offset,
         Allocation inputAllocation, Allocation outputAllocation, int convType, int parallelOFMs,
        ...
        int[] conv1TypeSet = {1}; //{1, 2, 4, 6, 8, 12, 24};
        for (int convType : conv1TypeSet) {
            //227*227*4 with 7*7*96 => 111*111*96
            int parallelOFMs = 96 / convType;
            //                         wtsz_f4   biassz  wt      bias         exespacesz
            paraConvRelu(rs, convNet, 7 * 7 * 96, 96, conv1_w, conv1_b, 111 * 111 * parallelOFMs,
            //      K   Wout Hout  Win Hin  M   N  S pad N_new offset
                    7, 111, 111, 227, 227, 96, 3, 2, 0,    1,     0,
            //          input          output         convtype
                    imgAllocation, conv1Allocation, convType,  parallelOFMs, "SqueezeNet/Logs", String.valueOf(convType) + ".txt",
                    "Conv1 (ms): ", logEnable);
            if (debug) {
                ...
                Log.e(tag,"conv1 output:"+Arrays.toString(tmp));
        ...
        if (debug) {
            ...
            Log.e(tag,"Pool1 output:"+Arrays.toString(pool1));
            return;
        }
        Log.e(tag, "Pool1 finished.");

        //55*55*96 x 1*1*96*16 => 55*55*16
        ...
        for (int convType : fire2_expand_TypeSet) {
            ...
            paraConvRelu(rs, convNet, 4 * 64, 64, fire2_expand1x1_w, fire2_expand1x1_b, 55 * 55 * parallelOFMs, 1,
                    //w  h  w   h   m   n   s  pd nnew offset
                    55, 55, 55, 55, 64, 16, 1, 0, 4, 0,
                    fire2_squeeze1x1_Allocation, fire2_expand_Allocation, convType,
                    parallelOFMs, "SqueezeNet/Logs", String.valueOf(convType) + ".txt",
                    "fire2_expand1x1 (ms): ", logEnable);
            //Thread.sleep(sleepTime);
            paraConvRelu(rs, convNet, 3 * 3 * 4 * 64, 64, fire2_expand3x3_w, fire2_expand3x3_b, 55 * 55 * parallelOFMs, 3,
                    55, 55, 55, 55, 64, 16, 1, 1, 4, 55 * 55 * 64,
                    fire2_squeeze1x1_Allocation, fire2_expand_Allocation, convType,
                    parallelOFMs, "SqueezeNet/Logs", String.valueOf(convType) + ".txt","fire2_expand3x3 (ms): ", logEnable);
            if (debug) {
        ...
        Log.e(tag, "Fire2_expand finished.");
        ...
        Log.e(tag, "Fire3_expand finished.");
        ...
        Log.e(tag, "Fire4_expand finished.");
        ...
        Log.e(tag, "Fire5_expand finished.");
        ...
        Log.e(tag, "Fire6_expand finished.");
        ...
        Log.e(tag, "Fire7_expand finished.");
        ...
        Log.e(tag, "Fire8_expand finished.");
        ...
        Log.e(tag, "Fire9_expand finished.");

        // 13*13*512 => 15*15*1000
        ...
        for (int convType : conv10TypeSet) {
            ...
            paraConvRelu(rs, convNet, 128 * 1000, 1000, conv10_w, conv10_b, 15 * 15 * parallelOFMs,
                    1, //Kernel size
            //     wout hout  win  hin   M    N    S  pad N_new offset
                    15, 15,   13, 13,   1000, 512, 1, 1,    128, 0,
                    fire9_expand_Allocation, conv10Allocation, convType,
                    parallelOFMs, "SqueezeNet/Logs", String.valueOf(convType) + ".txt",
                    "Conv10 (ms): ", logEnable);
            if (debug) {
    ...
    public float SqueezeNetInference (Context context) {
        ...
        for (int imgCount = 0; imgCount < 5000; imgCount++) {
            ...
            Log.e(tag, String.valueOf(lbls[imgCount]) + "," + String.valueOf(maxIndex));
            Log.e(tag, "Sample:" + String.valueOf(imgCount) + ", Correct: " + String.valueOf(correct));
        }
        float accuracy = correct / 5000.0f;
        Log.e(tag, "Accuracy:" + String.valueOf(accuracy));
        return  accuracy;
    ...
    private void Conv(RenderScript rs, ScriptC_convNet convNet,
                      int wghtSzF4, int biasSz,
        ...
        convNet.set_K(K); //kernel size
        convNet.set_Wout(Wout);
        convNet.set_Hout(Hout);
        convNet.set_Hin(Hin);
        convNet.set_Win(Win);
        convNet.set_M(M); //filter number
        convNet.set_N(N); //input channel number
        convNet.set_S(S); //stride
        convNet.set_pad(pad); //pad
        convNet.set_N_new(N_new); //input channel number /4
        convNet.set_offset(offset); //for merge
        convNet.set_parallelOFMs(parallelOFMs); //parallel exe space number
        ...
        convNet.forEach_conv(exeSpace);

        long end = System.currentTimeMillis();

        Log.d(tag,"My Conv time:"+ String.valueOf(end-start)+"ms\n");
    ...
    private void    paraConvRelu (RenderScript rs, ScriptC_convNet convNet, int wghtSzF4, int biasSz,
        ...
        * */
         ...
         * input :  227 * 227 * 4
         * output : 111 * 111 * 96
         * K : kernel size, height = weight
         * Wout,Hout: output width and height
         * Win, Hin : input  width and height
         * M : kernel number, namely number of filter
         * N : input channels
         * N_new : input channels/4
         * offset : 0
         * S : stride 2
         * pad : 0
         *
    ...
    private void paraReshape(RenderScript rs, ScriptC_convNet convNet, Allocation outputAllocation) {
        ...
        convNet.set_in(imgAllocation); //227*227*3
        convNet.set_output(outputAllocation); //227*227*4
        convNet.forEach_reshape(exeSpace);
    }
    public boolean loadImg(float[] data){

        loader(data.length, "/SqueezeNet/Parameters/Vectorized/img.bin", data);
        Log.e(tag,"Load Img finished.");
//        String buff=new String();
//        for(float i:data){
//            buff+=String.format("%.2f ",i);
//        }
//        Log.e(tag,buff);
        return true;
    }
    ...
    private void loadParameters(String logFolder, String logFile, String paramsDir, boolean logEnable) {
        ...
        Log.d("Net","All data loaded to RAM!");
    }
    ...
    private void softmax(float[] in, float[] out, int N, String logFolder, String logFile,
        ...
        Log.e(tag,"max index : "+ String.valueOf(maxAt));
